...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#E1F0FF]">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#E1F0FF]/80 backdrop-blur-md border-b border-[#B8D4E8]">
        <div className="max-w-7xl mx-auto px-6 md:px-12 h-16 flex items-center justify-between">
          ...
          <Button 
            ...
            onClick={login}
            className="bg-[#22438E] text-white hover:bg-[#1A3A7A] rounded-full px-6"
          >
            Sign In
          </Button>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="animate-fade-in">
              ...
              <h1 className="text-5xl md:text-7xl font-light tracking-tight leading-[1.1] text-[#000000] mb-6">
                Your personal
                <span className="block mt-2">
                  <span className="bg-[#7CBAE6] px-3 py-1 rounded">AI tutor</span>
                </span>
              </h1>
              <p className="text-lg md:text-xl text-[#333333] leading-relaxed max-w-lg mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button 
                  ...
                  onClick={login}
                  className="bg-[#22438E] text-white hover:bg-[#1A3A7A] rounded-lg px-8 py-6 text-lg font-medium group"
                >
                  Get Started
                ...
                <Button 
                  variant="outline"
                  className="border-[#000000] text-[#000000] hover:bg-[#D0E6F9] rounded-lg px-8 py-6 text-lg"
                >
                  Learn More
                </Button>
              </div>
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-xl p-4 shadow-lg border border-[#B8D4E8] animate-fade-in" style={{ animationDelay: '0.4s' }}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#666666]">Encouraging & insightful</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 px-6 md:px-12 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm text-[#666666] uppercase tracking-widest mb-4">Features</p>
            <h2 className="text-3xl md:text-5xl font-light tracking-tight text-[#000000]">
          ...
          <div className="grid md:grid-cols-3 gap-8 stagger-children">
            ...
            <div className="bg-[#E1F0FF] rounded-xl p-8 hover:-translate-y-1 transition-transform duration-300">
              ...
              <h3 className="text-xl font-normal text-[#000000] mb-3">Weekly Workbooks</h3>
            ...
            {/* Feature 2 */}
            <div className="bg-[#E1F0FF] rounded-xl p-8 hover:-translate-y-1 transition-transform duration-300">
              <div className="w-12 h-12 bg-[#7CBAE6] rounded-xl flex items-center justify-center mb-6">
                <Users className="w-6 h-6 text-[#000000]" />
              </div>
              <h3 className="text-xl font-normal text-[#000000] mb-3">Cohort Management</h3>
              <p className="text-[#333333] leading-relaxed">
      ...
      <section className="py-20 px-6 md:px-12">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-light tracking-tight text-[#000000] mb-6">
          ...
          <Button 
            ...
            onClick={login}
            className="bg-[#22438E] text-white hover:bg-[#1A3A7A] rounded-full px-10 py-6 text-lg font-medium"
          >
            Start Free Today
          </Button>
        </div>
      ...
      {/* Footer */}
      <footer className="py-8 px-6 md:px-12 border-t border-[#B8D4E8]">
