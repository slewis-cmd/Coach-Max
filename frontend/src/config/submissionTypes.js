...
export const SUBMISSION_TYPES = [
  ...
  },
  {
    ...
    description: 'Investor-style pitch deck. PDF, PowerPoint, Word writeup, or Excel/CSV supporting model.',
    accept: 'application/pdf,application/vnd.ms-powerpoint,application/vnd.openxmlformats-officedocument.presentationml.presentation,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,text/csv,.pdf,.ppt,.pptx,.doc,.docx,.xlsx,.xls,.csv',
    extensions: ['pdf', 'ppt', 'pptx', 'doc', 'docx', 'xlsx', 'xls', 'csv'],
    inputKind: 'file',
    icon: 'Presentation',
  },
  {
